...
describe('ProductController', () => {
  ...
  describe('#createProduct', () => {
    ...
    it('should return the created product', async () => {
      ...
      const product: Product = { id: 666, price: 999, name: 'Product 1', owner };
  ...
  describe('#getPublicProducts', () => {
    it('should return all public products', async () => {
      // GIVEN
      const owner = new User()
      const product1: Product = { id: 666, price: 999, name: 'Product 1', owner };
      const product2: Product = { id: 111, price: 222, name: 'Product 2', owner };
  ...
  describe('#getLoggedUsersProducts', () => {
    it('should return all logged in users\' products', async () => {
      ...
      jest.spyOn(productService, 'getLoggedUsersProducts').mockReturnValueOnce(Promise.resolve(products));

      // WHEN
      const result = await productController.getLoggedUsersProducts({ user: { email: 'example@email.com' } });
